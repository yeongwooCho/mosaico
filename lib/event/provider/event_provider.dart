...
class EventStateNotifier extends StateNotifier<List<EventModel>> {
  ...
  void initItems() {
    state = [
      EventDetailModel(
        id: '0',
        title: '[예약구매] 비기너 디자이너를 위한 책',
        imagePath: 'asset/img/events/0.png',
        tags: [
          '#시각적커뮤니케이션',
          '#사용자경험 디자인',
          '#디자인 사고',
        ...
        detail: '''비기너 디자이너를 위한 책''',
        condition: "목표 참여자: 500명",
        graphData: [
          1,
          24,
          62,
      ...
      EventDetailModel(
        id: '1',
        title: "[설문조사] 스테이크 쌀국수 시제품 체험단 모집",
        imagePath: 'asset/img/events/1.png',
        tags: [
          '#고기의질감과맛',
          '#신선한야채토핑',
          '#향긋한국물베이스',
        ...
        isParticipation: false,
        detail:
            '''이 제품은 시제품입니다. 시제품이지만 검증된 기관에서 수차례 확인후 체험단을 모집합니다. 안심하시고 드셔도 됩니다. 드시고 상세한 설문조사에 참여 해 주시면 됩니다.''',
        condition:
      ...
      EventDetailModel(
        id: '2',
        title: '[예약구매] 도도나 기미팩트',
        imagePath: 'asset/img/events/2.png',
        tags: [
          '#멜라닌억제',
          '#피부미백효과',
          '#자외선차단기능',
        ...
        detail: '도도나 기미팩트',
        condition: "참여기간: 2024/05/12 ~ 2024/05/17\n목표참여자: 500명",
        graphData: [
          1,
          54,
          62,
      ...
      EventDetailModel(
        id: '3',
        title: '[설문조사] 비토우유 시제품 체험단 모집',
        imagePath: 'asset/img/events/3.png',
        tags: [
          '#비건친화적',
          '#저칼로리',
          '#락토오스프리',
      ...
      EventDetailModel(
        id: '4',
        title: '[이벤트] 루루 냄비런칭 기념 이벤트 NEW',
        imagePath: 'asset/img/events/4.png',
        tags: [
          '#다용도사용',
          '#내구성높은소재',
          '#열분배우수',
      ...
      EventDetailModel(
        id: '5',
        title: '[아이디어] 귀여운 강아지 옷 어때요? 통풍이 잘되고 시원해요.',
        // imagePath: 'asset/img/event/5.png',
        imagePath: 'asset/img/events/5.png',
        tags: [
          '#쉽게벗겨져요',
          '#통풍이잘되요',
          '#친환경소재',
        ...
        isLike: true,
        isParticipation: false,
        detail: '귀여운 강아지 옷 어때요? 통풍이 잘되고 시원해요.',
        condition:
            '''참여기간: 2024/05/12 ~ 2024/05/17\n목표참여자: 500명''',
        graphData: [
          1,
      ...
      EventDetailModel(
        ...
        imagePath: 'asset/img/events/6.png',
        tags: [
          '#고급겨울패딩',
          '#백화점퀄리티',
          '#따뜻한소재',
      ...
      EventDetailModel(
        ...
        imagePath: 'asset/img/events/7.png',
        tags: [
          '#루카친환경전기차',
          '#도심주행최적화',
          '#혁신적인디자인',
        ...
        condition: "참여조건: 30대 이상 남여, 신용 2등급이상\n참여미션: 없음\n참여기간: 2024/05/12 ~ 2024/05/17\n혜택\n - 1등  네이버페이 30만원 (1명)\n - 2등 스타벅스 커피쿠폰 5만원(3명)\n - 3등 스타벅스 아아 쿠폰 (5명)",
        graphData: [
          1,
          54,
          62,
      ...
      EventDetailModel(
        ...
        imagePath: 'asset/img/events/8.png',
        tags: [
          '#48시간지속',
          '#고보습립케어',
          '#장시간유지립스틱',
      ...
      EventDetailModel(
        ...
        imagePath: 'asset/img/events/9.png',
        tags: [
          '#피부톤균일화',
          '#미백기능성',
          '#자연유래성분',
        ...
        isRatingDone: false,
        detailImages: [
          'asset/img/events/details/0.png',
        ],
      ),
      EventDetailModel(
        id: '10',
        title: '[설문조사] 운스샴푸 시제품체험',
        imagePath: 'asset/img/events/10.png',
        tags: [
          '#모발영양강화',
          '#천연성분함유',
          '#두피건강케어',
      ...
      EventDetailModel(
        ...
        imagePath: 'asset/img/events/11.png',
        tags: [
          '#부드러운각질제거',
          '#보습효과강화',
          '#피부진정효과',
        ...
        graphData: [1, 54, 62, 82, 93, 155, 255, 1611, 1711, 1811],
        ratings: ref.read(ratingsRandomProvider(7)),
        category: '',
        isRatingDone: false,
        detailImages: [
